function changeText(btnNum) {
    ...
    par1.classList.remove("animate")
    par1.offsetWidth
    par1.classList.add("animate")
    par2.classList.remove("animate")
    par2.offsetWidth
    par2.classList.add("animate")
    par3.classList.remove("animate")
    par3.offsetWidth
    par3.classList.add("animate")
    par4.classList.remove("animate")
    par4.offsetWidth
    par4.classList.add("animate")
